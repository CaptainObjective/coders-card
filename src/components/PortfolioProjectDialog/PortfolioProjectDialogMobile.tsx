...
export const PortfolioProjectDialogMobile = (props: PortfolioProjectDialogVariantProps) => {
  ...
  return (
    <Dialog fullScreen open={props.isOpen} scroll="body">
      ...
      <Box position="relative" width="100vw" height="56.25vw">
        <Image layout="fill" objectFit="cover" src={props.imageUrl} alt={props.title} />
      </Box>
